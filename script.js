document.addEventListener('DOMContentLoaded', function () {
  ...
  const OBSERVED_SELECTOR = '.fade-in, .scroll-animate, [data-animate]';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '640242a4-dc3e-470f-aa96-5b673b23f9b2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '640242a4-dc3e-470f-aa96-5b673b23f9b2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '640242a4-dc3e-470f-aa96-5b673b23f9b2';
